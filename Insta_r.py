...
class Thanatos:
    ...
    def get_user_id(self, username):
        ...
        try:
            ...
            url = f"https://api.instagram.com/v1/users/search?q={username}&access_token={self.access_token}"
    ...
    def report_account(self, account_id, reason):
        ...
        try:
            ...
            url = f"https://api.instagram.com/v1/users/{account_id}/flag"
...
if __name__ == "__main__":
    ...
    access_token = "IGQVJXZAkhRcENZAVENBTE5acnMweXJ2dzRTbTFoZAFJ3WWZALZAXRHR2dqTjRRODdIVERmY2hfT2hBZAHd6SzRfNzJsOEdLOTRhRFE4UDNkTzFaYmNhOERyODhqZAUl3MEVPWExPTWswXzN0eHZASVHB0d0JFUgZDZD"
